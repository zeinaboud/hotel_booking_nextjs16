        ...
        >
          ...
          <div className="check-in-out-input gap-4 relative">
            ...
            {suggestions.length > 0 && (
              <ul className="border top-9 md:top-20  bg-white dark:bg-input dark:text-white absolute z-20 w-full rounded-md shadow">
                {suggestions.map((s) => (
                  <li
                    key={s.id}
          ...
          <div className="check-in-out-input gap-4">
            ...
            <Input type="date" {...register('checkIn')} className="shadow-sm shadow-chart-4/45" />
          </div>
          ...
          <div className="check-in-out-input gap-2">
            ...
            <Input type="date" {...register('checkOut')} className="shadow-sm shadow-chart-4/45" />
          </div>

          {/* Search button */}
          <Button
            type="submit"
            className="btn-gradient-gold flex items-center rounded mt-6 md:mt-9 justify-center"
          >
