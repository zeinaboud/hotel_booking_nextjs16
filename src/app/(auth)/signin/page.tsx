...
import { signInSchema, signInSchemaType } from '@/lib/validation/validations';
  ...
  return (
    <>
          ...
          <div>
            <span className="inline-flex items-center ">
              ...
              <form action={googleAuth}>
                <button type="submit">
                  <FcGoogle
                    className=" cursor-pointer  border-l-2 border-black  dark:border-l-2 dark:border-white pl-2"
                    size={30}
                  />
                </button>
              </form>
      ...
      <form
        ...
        className="space-y-4  md:mt-10 mt-5"
        action="#"
      >
        <input
          type="email"
        ...
        <button
          type="submit"
          className="btn-gradient-contrast  btn-gradient-contrast:hover mx-auto block"
        >
          Sign In
        </button>
      </form>
