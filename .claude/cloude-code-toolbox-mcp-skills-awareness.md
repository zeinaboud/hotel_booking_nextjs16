...
_Generated: 2026-06-23T09:30:59.402Z_
...
Workspace `mcp.json` _(folder: booking-hotel-app)_

- **c:\Users\RESTART CENTER\Desktop\react\copiesHotelBooking\booking-hotel-app\.mcp.json** — _File missing_

_No active workspace servers in mcp.json._

## MCP — user profile

- **C:\Users\RESTART CENTER\.claude.json** — _File exists — no servers defined_
